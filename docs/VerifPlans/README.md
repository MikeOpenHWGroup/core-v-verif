...
This directory contains Verification Plans and plan templates applicable to all CORE-V cores.
...
The subdirectories contain a set of plans for each standard RISC-V ISA base feature or extension.
...
Any plans for Privileged Specification, Debug Specification or other core-specific functionality should reside within plans with the specific core.
